...
Route::get('posts/{id}', [PostController::class, 'show'])->middleware('auth:sanctum')->name('api.posts.show');
Route::post('posts', [PostController::class, 'store'])->middleware('auth:sanctum')->name('api.posts.store');
Route::put('posts/{id}', [PostController::class, 'update'])->middleware('auth:sanctum')->name('api.posts.update');
