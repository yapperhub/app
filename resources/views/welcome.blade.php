                        ...
                        <div class="grid gap-6 lg:grid-cols-2 lg:gap-8">
                            ...
                            >
                                <div id="screenshot-container" class="relative flex w-full flex-1 items-stretch">
                                    ...
                                    />
                                    <div
                                        class="from-transparent dark:via-zinc-900 dark:to-zinc-900 absolute -bottom-16 -left-16 h-40 w-[calc(100%+8rem)] bg-gradient-to-b via-white to-white"
                                    ></div>
                                </div>
                            ...
                            <div
                                class="dark:bg-zinc-900 dark:ring-zinc-800 flex items-start gap-4 rounded-lg bg-white p-6 shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] lg:pb-10"
                            >
                                <div
                                    class="flex size-12 shrink-0 items-center justify-center rounded-full bg-[#FF2D20]/10 sm:size-16"
                                >
