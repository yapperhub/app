...
@section('content')
    <div class="main">
        <div class="container mx-auto px-4 py-8">
            <h1 class="text-center text-3xl font-bold">Privacy</h1>
            <p class="mt-4 text-center text-gray-600">Last updated: Friday, November 8, 2024</p>
            <div class="mt-8" id="privacy">
                <h2 class="text-2xl font-bold">Privacy Policy</h2>
                <p class="mt-4 text-lg text-gray-600">
                    Your privacy is important to us. It is Yapper Hub's policy to respect your privacy regarding any
                    information we may collect from you across our website,
                    <a href="{{ route('welcome') }}" class="text-blue-500">https://yapperhub.com</a>
            ...
            <div class="mt-8" id="securing-api-keys">
                <h2 class="text-2xl font-bold">Securing API Keys</h2>
                <p class="mt-4 text-lg text-gray-600">
                    API keys are used to authenticate requests made to third party integration. To ensure that your API
                    keys are secure, we recommend that you keep them confidential and do not share them publicly. We on
                    our side will ensure that your API keys are stored securely with encryption and other security
                    measures. We will not share your API keys with any third party unless required to by law.
                </p>
            </div>
        </div>
